...
import (
	...
	scheme "github.com/ahrtr/etcd-operator/pkg/generated/clientset/versioned/scheme"
...
func newEtcdClusters(c *ClustersV1alpha1Client, namespace string) *etcdClusters {
	return &etcdClusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
